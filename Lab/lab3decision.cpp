...
int main()
{
    ...
    string ansThree, ansFour, ansFive, ansFull, ansLS, ansSS;
    ...
    // second nested loop is to answer long strait and short stright question
    // if you want 12345,23456;1234,2345,3456, one 3 and one 4 are necessary
    if (count3 == 1 && count4 == 1)
    {
        
        // small short 1234,2345,3456 three scenarios
